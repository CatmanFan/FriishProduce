...
* WAD/U8 handling using libWiiSharp and U8Mii (Wii.cs)
...
* **[Wii.cs Tools](https://github.com/dnasdw/showmiiwads/tree/Wii.cs_Tools)** (U8Mii, from [ShowMiiWads](https://code.google.com/archive/p/showmiiwads/source)) by Leathl.
