...
namespace FriishProduce.Injectors
{
    public class MSX
    {
        ...
        public void ReplaceROM()
        {
            ...
            // ------------------------
            // Check if MSX1 ROM exists
            // ------------------------

            string rom = Paths.WorkingFolder_Content5 + $"SLOT1.ROM";
            ...
            {
                // ------------------------
                // Check if MSX2 ROM exists
                // ------------------------

                rom = Paths.WorkingFolder_Content5 + $"MEGAROM.ROM";
        ...
        {
            return File.Exists(Paths.WorkingFolder_Content5 + "banner.bin") ? Paths.WorkingFolder_Content5 + "banner.bin" : null;
        }
