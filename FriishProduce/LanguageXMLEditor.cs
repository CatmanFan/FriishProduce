    ...
    public partial class LanguageXMLEditor : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    if (locale.EnglishName == comboBox1.SelectedItem.ToString() && File.Exists(Paths.Languages + locale.Name + ".xml"))
                    {
                        XmlDocument doc = new XmlDocument();
                        doc.PreserveWhitespace = false;
                        doc.Load(Paths.Languages + locale.Name + ".xml");
            ...
            button4.Enabled = button3.Enabled = button2.Enabled = true;
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            foreach (var locale in CultureInfo.GetCultures(CultureTypes.AllCultures))
                ...
                {
                    SaveAs.FileName = locale.Name + ".xml";
                        ...
                        foreach (XmlNode main in x.ChildNodes)
                            if (main.Name.ToLower() == "language")
                            {
                                ...
                                using (XmlWriter w = XmlWriter.Create(sb, opts))
                                {
                                    ...
                                    File.WriteAllLines(SaveAs.FileName, output);
                                }
                            }
                    }
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            dataGridView1.Enabled = button4.Enabled = button3.Enabled = button2.Enabled = false;
            dataGridView1.Rows.Clear();
        }
        ...
        {
            for (int i = 0; i < dataGridView1.Rows.Count; i++)
                dataGridView1.Rows[i].DefaultCellStyle.BackColor = dataGridView1.Rows[i].Cells[3].Value == null ? Color.MistyRose : Color.White;
        }
